...
for.cond.i:                                       ; preds = %for.cond.i.pre_entry_bb, %for.cond.cleanup5.i
  %i.0.i = phi i64 [ %inc32.i, %for.cond.cleanup5.i ], [ 0, %for.cond.i.pre_entry_bb ]
...
for.body6.i:                                      ; preds = %for.cond2.i
  ...
  store float %mul8.i, ptr addrspace(1) %arrayidx.i, align 4, !tbaa !16
...
attributes #0 = { mustprogress norecurse nounwind "frame-pointer"="all" "no-trapping-math"="true" "polly-optimized" "stack-protector-buffer-size"="8" "sycl-module-id"="syrk.cpp" "sycl-optlevel"="3" "sycl-single-task" "uniform-work-group-size"="true" }
