...
for.cond.i:                                       ; preds = %polly.split_new_and_old, %for.cond.cleanup5.i
  %i.0.i = phi i64 [ %inc12.i, %for.cond.cleanup5.i ], [ 0, %polly.split_new_and_old ]
...
_ZZZN14Polybench_Bicg3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit: ; preds = %polly.loop_exit21, %for.cond.i, %polly.loop_if
  ret void
...
polly.loop_exit21:                                ; preds = %polly.loop_exit28
  ...
  br i1 %polly.loop_cond.not.not, label %polly.loop_preheader20, label %_ZZZN14Polybench_Bicg3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit
...
polly.loop_exit28:                                ; preds = %polly.loop_exit36, %polly.loop_if25
...
polly.loop_exit36.loopexit:                       ; preds = %polly.stmt.for.body6.i
  store float %p_, ptr addrspace(1) %scevgep43, align 4, !alias.scope !22, !noalias !25
  br label %polly.loop_exit36

polly.loop_exit36:                                ; preds = %polly.loop_exit36.loopexit, %polly.loop_if33
  %polly.indvar_next31 = add nuw nsw i64 %polly.indvar30, 1
  %polly.loop_cond32.not.not = icmp slt i64 %polly.indvar30, %15
  br i1 %polly.loop_cond32.not.not, label %polly.loop_if33, label %polly.loop_exit28

polly.loop_if33:                                  ; preds = %polly.loop_if33.preheader, %polly.loop_exit36
...
for.cond.i:                                       ; preds = %for.cond.i.pre_entry_bb, %for.cond.cleanup5.i
...
attributes #0 = { mustprogress norecurse nounwind "frame-pointer"="all" "no-trapping-math"="true" "polly-optimized" "stack-protector-buffer-size"="8" "sycl-module-id"="bicg.cpp" "sycl-optlevel"="3" "sycl-single-task" "uniform-work-group-size"="true" }
