...
for.cond.i.loopexit:                              ; preds = %for.cond2.i
  br label %for.cond.i, !llvm.loop !13

for.cond.i:                                       ; preds = %for.cond.i.preheader, %for.cond.i.loopexit
  %i.0.i = phi i64 [ %add19.i, %for.cond.i.loopexit ], [ 1, %for.cond.i.preheader ]
  %cmp.i = icmp ult i64 %i.0.i, %sub.i
  br i1 %cmp.i, label %for.cond2.i.preheader, label %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit
...
for.cond2.i:                                      ; preds = %for.body7.i, %for.cond2.i.preheader
  %j.0.i = phi i64 [ %add50.i, %for.body7.i ], [ 1, %for.cond2.i.preheader ]
  %cmp5.i = icmp ult i64 %j.0.i, %sub.i
  br i1 %cmp5.i, label %for.body7.i, label %for.cond.i.loopexit
...
_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit: ; preds = %for.cond.i
  br label %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit

_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit1: ; preds = %polly.loop_exit39
  br label %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit

_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit: ; preds = %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit1, %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit, %polly.loop_if
  ret void
...
polly.loop_exit39:                                ; preds = %polly.loop_exit46
  ...
  br i1 %polly.loop_cond.not.not, label %polly.loop_preheader38, label %_ZZZN23Polybench_2DConvolution3runERSt6vectorIN4sycl3_V15eventESaIS3_EEENKUlRNS2_7handlerEE_clES8_ENKUlvE_clEv.exit.loopexit1
...
polly.loop_exit46.loopexit:                       ; preds = %polly.loop_exit54
  br label %polly.loop_exit46

polly.loop_exit46:                                ; preds = %polly.loop_exit46.loopexit, %polly.loop_if43
...
polly.loop_if43:                                  ; preds = %polly.loop_preheader38, %polly.loop_exit46
  ...
  %33 = mul i64 %polly.indvar40, -32
  %34 = add i64 %_arg_size_, %33
  %smin = call i64 @llvm.smin.i64(i64 %34, i64 34)
  %35 = add i64 %smin, -3
  %smax = call i64 @llvm.smax.i64(i64 %35, i64 0)
  %36 = add nuw i64 %smax, 1
...
polly.loop_if51.preheader:                        ; preds = %polly.loop_if43
  %37 = shl nsw i64 %polly.indvar40, 5
  %38 = sub nsw i64 %_arg_size_, %37
  %39 = tail call i64 @llvm.smin.i64(i64 %38, i64 34)
  %40 = add nsw i64 %39, -3
  %polly.loop_guard55 = icmp sgt i64 %38, 2
  br label %polly.loop_if51

polly.loop_exit54.loopexit:                       ; preds = %middle.block, %polly.stmt.for.body7.i
  br label %polly.loop_exit54

polly.loop_exit54:                                ; preds = %polly.loop_exit54.loopexit, %polly.loop_if51
  %polly.indvar_next49 = add nuw nsw i64 %polly.indvar48, 1
  %polly.loop_cond50.not.not = icmp slt i64 %polly.indvar48, %32
  br i1 %polly.loop_cond50.not.not, label %polly.loop_if51, label %polly.loop_exit46.loopexit

polly.loop_if51:                                  ; preds = %polly.loop_exit54, %polly.loop_if51.preheader
...
polly.stmt.for.body7.i.preheader:                 ; preds = %polly.loop_if51
  %41 = add nuw nsw i64 %29, %polly.indvar48
  %42 = mul i64 %28, %41
  %43 = shl i64 %41, 2
  %44 = add i64 %43, 4
  %45 = mul i64 %_arg_size_, %44
  %46 = add i64 %43, 8
  %47 = mul i64 %_arg_size_, %46
  %min.iters.check = icmp ult i64 %36, 4
  br i1 %min.iters.check, label %scalar.ph, label %vector.ph

vector.ph:                                        ; preds = %polly.stmt.for.body7.i.preheader
  %n.mod.vf = urem i64 %36, 4
  %n.vec = sub i64 %36, %n.mod.vf
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %48 = add i64 %index, 0
  %49 = add nuw nsw i64 %37, %48
  %50 = shl i64 %49, 2
  %51 = add i64 %42, %50
  %52 = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %51
  %53 = getelementptr float, ptr addrspace(1) %52, i32 0
  %wide.load = load <4 x float>, ptr addrspace(1) %53, align 4, !alias.scope !22, !noalias !25
  %54 = add i64 %45, %50
  %55 = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %54
  %56 = getelementptr float, ptr addrspace(1) %55, i32 0
  %wide.load2 = load <4 x float>, ptr addrspace(1) %56, align 4, !alias.scope !22, !noalias !25
  %57 = fmul <4 x float> %wide.load2, <float 0xBFD3333340000000, float 0xBFD3333340000000, float 0xBFD3333340000000, float 0xBFD3333340000000>
  %58 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load, <4 x float> <float 0x3FC99999A0000000, float 0x3FC99999A0000000, float 0x3FC99999A0000000, float 0x3FC99999A0000000>, <4 x float> %57)
  %59 = add i64 %47, %50
  %60 = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %59
  %61 = getelementptr float, ptr addrspace(1) %60, i32 0
  %wide.load3 = load <4 x float>, ptr addrspace(1) %61, align 4, !alias.scope !22, !noalias !25
  %62 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load3, <4 x float> <float 0x3FD99999A0000000, float 0x3FD99999A0000000, float 0x3FD99999A0000000, float 0x3FD99999A0000000>, <4 x float> %58)
  %63 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %51
  %64 = getelementptr float, ptr addrspace(1) %63, i32 0
  %wide.load4 = load <4 x float>, ptr addrspace(1) %64, align 4, !alias.scope !22, !noalias !25
  %65 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load4, <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float> %62)
  %66 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %54
  %67 = getelementptr float, ptr addrspace(1) %66, i32 0
  %wide.load5 = load <4 x float>, ptr addrspace(1) %67, align 4, !alias.scope !22, !noalias !25
  %68 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load5, <4 x float> <float 0x3FE3333340000000, float 0x3FE3333340000000, float 0x3FE3333340000000, float 0x3FE3333340000000>, <4 x float> %65)
  %69 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %59
  %70 = getelementptr float, ptr addrspace(1) %69, i32 0
  %wide.load6 = load <4 x float>, ptr addrspace(1) %70, align 4, !alias.scope !22, !noalias !25
  %71 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load6, <4 x float> <float 0x3FE6666660000000, float 0x3FE6666660000000, float 0x3FE6666660000000, float 0x3FE6666660000000>, <4 x float> %68)
  %72 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %51
  %73 = getelementptr float, ptr addrspace(1) %72, i32 0
  %wide.load7 = load <4 x float>, ptr addrspace(1) %73, align 4, !alias.scope !22, !noalias !25
  %74 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load7, <4 x float> <float 0xBFE99999A0000000, float 0xBFE99999A0000000, float 0xBFE99999A0000000, float 0xBFE99999A0000000>, <4 x float> %71)
  %75 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %54
  %76 = getelementptr float, ptr addrspace(1) %75, i32 0
  %wide.load8 = load <4 x float>, ptr addrspace(1) %76, align 4, !alias.scope !22, !noalias !25
  %77 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load8, <4 x float> <float 0xBFECCCCCC0000000, float 0xBFECCCCCC0000000, float 0xBFECCCCCC0000000, float 0xBFECCCCCC0000000>, <4 x float> %74)
  %78 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %59
  %79 = getelementptr float, ptr addrspace(1) %78, i32 0
  %wide.load9 = load <4 x float>, ptr addrspace(1) %79, align 4, !alias.scope !22, !noalias !25
  %80 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %wide.load9, <4 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000>, <4 x float> %77)
  %81 = getelementptr i8, ptr addrspace(1) %scevgep88, i64 %54
  %82 = getelementptr float, ptr addrspace(1) %81, i32 0
  store <4 x float> %80, ptr addrspace(1) %82, align 4, !alias.scope !25, !noalias !22
  %index.next = add nuw i64 %index, 4
  %83 = icmp eq i64 %index.next, %n.vec
  br i1 %83, label %middle.block, label %vector.body, !llvm.loop !27

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %36, %n.vec
  br i1 %cmp.n, label %polly.loop_exit54.loopexit, label %scalar.ph

scalar.ph:                                        ; preds = %polly.stmt.for.body7.i.preheader, %middle.block
  %bc.resume.val = phi i64 [ %n.vec, %middle.block ], [ 0, %polly.stmt.for.body7.i.preheader ]
  br label %polly.stmt.for.body7.i

polly.stmt.for.body7.i:                           ; preds = %polly.stmt.for.body7.i, %scalar.ph
  %polly.indvar56 = phi i64 [ %polly.indvar_next57, %polly.stmt.for.body7.i ], [ %bc.resume.val, %scalar.ph ]
  %84 = add nuw nsw i64 %37, %polly.indvar56
  %85 = shl i64 %84, 2
  %86 = add i64 %42, %85
  %scevgep = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %86
  %_p_scalar_ = load float, ptr addrspace(1) %scevgep, align 4, !alias.scope !22, !noalias !25
  %87 = add i64 %45, %85
  %scevgep59 = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %87
  ...
  %88 = add i64 %47, %85
  %scevgep61 = getelementptr i8, ptr addrspace(1) %_arg_raw_A, i64 %88
  ...
  %scevgep65 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %86
  ...
  %scevgep69 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %87
  ...
  %scevgep73 = getelementptr i8, ptr addrspace(1) %scevgep64, i64 %88
  ...
  %scevgep77 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %86
  ...
  %scevgep81 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %87
  ...
  %scevgep85 = getelementptr i8, ptr addrspace(1) %scevgep76, i64 %88
  ...
  %scevgep89 = getelementptr i8, ptr addrspace(1) %scevgep88, i64 %87
  ...
  %polly.loop_cond58.not.not = icmp slt i64 %polly.indvar56, %40
  br i1 %polly.loop_cond58.not.not, label %polly.stmt.for.body7.i, label %polly.loop_exit54.loopexit, !llvm.loop !30
}
...
attributes #0 = { mustprogress norecurse nounwind "frame-pointer"="all" "no-trapping-math"="true" "polly-optimized" "stack-protector-buffer-size"="8" "sycl-module-id"="2dconvolution.cpp" "sycl-optlevel"="3" "sycl-single-task" "target-cpu"="neoverse-v2" "target-features"="+sve" "uniform-work-group-size"="true" }
